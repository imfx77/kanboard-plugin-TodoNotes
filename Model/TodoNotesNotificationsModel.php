    ...
    public function GetPendingNotifications($last_heartbeat, $new_heartbeat)
    {
        ...
        foreach ($potential_notifications as &$notification_to_evaluate) {
            ...
            if ($should_trigger) {
                ...
                $notification_to_evaluate = $this->dateParser->format($notification_to_evaluate, array('date_created', 'date_modified', 'date_notified', 'last_notified', 'date_restored'), $userDateTimeFormat);
